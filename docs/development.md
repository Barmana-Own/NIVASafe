...
API changes must enforce organization scope before reading an entity. Business calculations belong in `shared/domain` and require tests. Do not log passwords, tokens or provider keys.
