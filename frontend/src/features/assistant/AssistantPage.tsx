  ...
  return <section className="page-shell assistant-page">
    ...
    <div className="assistant-layout">
      ...
      <section className="chat-panel">
        ...
        <AutoSaveForm storageKey={composerDraftKey} className="composer" onSubmit={send}><input name="content" placeholder="پرسش HSE خود را بنویسید…" autoComplete="off" required/><button className="primary" aria-label="ارسال"><Icon name="arrow"/></button></AutoSaveForm>
