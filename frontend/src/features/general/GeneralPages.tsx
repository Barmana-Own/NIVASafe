...
export function DashboardPage() {
  ...
  return <section className="page-shell">
     <PageHeader eyebrow={t("dashboard.eyebrow")} title={t("dashboard.title")} description={t("dashboard.description")} actions={<><button className="ghost" type="button" aria-expanded={customizing} aria-controls="dashboard-layout-controls" data-scroll-target="#dashboard-layout-controls" data-scroll-focus=".widget-visibility-toggle" onClick={() => setCustomizing((value) => !value)}><Icon name="dashboard"/> {customizing ? t("dashboard.closeSettings") : t("dashboard.customize")}</button><Link className="primary button-link" to="/choose-path"><Icon name="plus"/> {t("dashboard.newAssessment")}</Link></>}/>
